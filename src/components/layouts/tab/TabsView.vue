<template>
  <div>
    ...
    <main :style="{ minHeight: `calc(100vh - ${contentDifferenceHeight}px)`,position:`relative`}" ref="mainEle">
      <transition v-if="!pageRefresh"
...
export default {
  ...
  computed: {
    ...mapState('setting', ['contentDifferenceHeight']),
